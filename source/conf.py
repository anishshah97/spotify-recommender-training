...
# spotify_recommendations documentation build
...
from spotify_recommendations import __version__ as release

# -- Project information -----------------------------------------------------

project = "spotify_recommendations"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "spotify_recommendationsdoc"
...
latex_documents = [
    (
        master_doc,
        "spotify_recommendations.tex",
        "spotify_recommendations Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spotify_recommendations",
        "Project spotify_recommendations codebase.",
        "Data-Science",
    )
]
